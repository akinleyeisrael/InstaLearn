...
namespace InstaLearn.Controllers
{
    public class Courses1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,CourseCategoryId,DateCreated,EndDate")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,CourseCategoryId,DateCreated,EndDate")] Course course)
        {
            if (ModelState.IsValid)
            {
